<template>
    ...
    >
        <template #bodyCell="{ column }">
            <template v-if="column.key === 'operation'">
                <a-button type="primary" class="sky"><ScanOutlined /></a-button>
            </template>
        </template>
    </a-table>
  </template>
  ...
  const columns: TableColumnsType = [
    { title: 'ทั้งหมด 6 รายการ', children: [
        { title: 'สถานะ', width: 100, dataIndex: 'id', key: '0',  },
        ...
        { title: 'ยอดเงิน', width: 100, dataIndex: 'name', key: 'name',  },
        { title: 'วันที่', width: 100, dataIndex: 'age', key: 'age' },
        { title: 'เพิ่มเติม', dataIndex: 'address', key: '1', width: 150 },
        { title: 'โดย', dataIndex: 'address', key: '2', width: 150 },
        {
            title: 'สลิป',
            key: 'operation',
            fixed: 'right',
