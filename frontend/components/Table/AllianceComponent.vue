<template>
  ...
  const columns: TableColumnsType = [
    { title: 'ทั้งหมด 6 รายการ', children: [
      { title: 'ลำดับ', width:80, dataIndex: 'name', key: 'name' },
      { title: 'ชื่อ', width:80, dataIndex: 'name', key: 'name' },
      { title: 'ค่าคอมมิชชั่น (%)', width: 150, dataIndex: 'name', key: 'name', fixed: 'left' },
      { title: 'ค่าส่งบริษัท (%)', dataIndex: 'address', key: '1', width: 100 },
      { title: 'ลิงค์สมัคร', dataIndex: 'address', key: '1', width: 150 },
      { title: 'ลิงค์ดูรายงาน', dataIndex: 'address', key: '1', width: 150 },
      { title: 'ประเภทคอมมิชชั่น', dataIndex: 'address', key: '1', width: 150 },
      {
              title: 'แก้ไข/ลบ',
              key: 'operation',
              fixed: 'right',
