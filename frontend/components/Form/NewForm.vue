<template>
    ...
    >
        <a-row>
            <a-col :span="24" :md="12">
                <div class="mx-1 my-1">
                    <label for="ชื่อโปรชั่น"><b>ชื่อข่าวสาร</b></label>
...
<script lang="ts" setup>
    ...
    import { createNewServices,editNewServices } from '~/services/newServices';
    ...
    const handleSubmit = async() => {
        ...
        if(action.value == "create"){
            const data = await createNewServices(formData);
            ...
            const data = await editNewServices(formData);
            if(data.status == "success"){
