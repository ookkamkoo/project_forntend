...
import { Fragment, isVNode, Comment, Text, defineComponent, reactive, getCurrentInstance, onUpdated, onUnmounted, watch, computed, inject, ref, provide, unref, shallowRef, watchEffect, triggerRef, createVNode, h, Transition, withDirectives, resolveDirective, cloneVNode, nextTick, toRef, withModifiers, vShow, render } from "vue";
...
if (process.env.NODE_ENV !== "production" && typeof module !== "undefined" && module && module.hot && false) {
  const win = void 0;
...
function syncRealContainer(container, option) {
  ...
  if (!cachedRealContainer || !contains(void 0, cachedRealContainer)) {
...
function cloneElement(vnode) {
  ...
  warning$1(typeof node.props.class !== "object", "class must be string");
  return node;
}
  ...
  setup(props, _ref) {
    ...
    if (process.env.NODE_ENV !== "production") {
      [["visible", "open"], ["onVisibleChange", "onOpenChange"]].forEach((_ref2) => {
        ...
        warning$1(props[deprecatedName] === void 0, "Tooltip", `\`${deprecatedName}\` is deprecated, please use \`${newName}\` instead.`);
      });
    }
    const {
      prefixCls,
...
export {
  abstractTooltipProps as $,
  booleanType as A,
  stringType as B,
  anyType as C,
  functionType as D,
  warning$1 as E,
  genFocusOutline as F,
  arrayType as G,
  useInjectDisabled as H,
  flattenChildren as I,
  cloneElement as J,
  Keyframes as K,
  omit as L,
  eventType as M,
  useCompactItemContext as N,
  NoCompactStyle as O,
  PropTypes as P,
  Button as Q,
  ResizeObserver as R,
  ...
  PresetColors as X,
  withInstall as Y,
  tooltipDefaultProps as Z,
  getTransitionName as _,
  classNames as a,
  capitalize as a0,
  genPresetColor as a1,
  isPresetColor as a2,
  isPresetStatusColor as a3,
  Wave as a4,
  Portal as a5,
  useConfigContextInject as a6,
  useToken as a7,
  initMotion as a8,
  Trigger as a9,
  skipFlattenKey as aa,
  buttonProps as ab,
  getArrowOffset as ac,
  roundedArrow as ad,
  genFocusStyle as ae,
  getPlacements as af,
  isValid as ag,
  textEllipsis as ah,
  resetIcon as ai,
  genCompactItemStyle as b,
  createContext as c,
  devWarning as d,
  clearFix as e,
  isValidElement as f,
  genComponentStyleHook as g,
  useLocaleReceiver as h,
  initDefaultProps as i,
  genCollapseMotion$1 as j,
  collapseMotion as k,
  localeValues as l,
  merge as m,
  getTransitionGroupProps as n,
  getTransitionProps as o,
  filterEmpty as p,
  useProviderSize as q,
  resetComponent as r,
  someType as s,
  tuple as t,
  useConfigInject as u,
  useProviderDisabled as v,
  warning$2 as w,
  useInjectGlobalForm as x,
  objectType as y,
  zoomIn as z
};
//# sourceMappingURL=collapseMotion-HiYDSwVT.js.map
