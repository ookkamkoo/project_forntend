import { _ as __nuxt_component_0, L as LayoutHeader, a as __nuxt_component_2, b as LayoutContent, c as LayoutFooter } from './LanguageComponent-BCfin9mq.mjs';
...
import './collapseMotion-HiYDSwVT.mjs';
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_a_layout_footer, { style: { "text-align": "center" } }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Ant Design \xA92018 Created by Ant UED `);
            } else {
              return [
                createTextVNode(" Ant Design \xA92018 Created by Ant UED ")
              ];
            }
          }),
          _: 1
...
//# sourceMappingURL=auth-67-21dcT.mjs.map
