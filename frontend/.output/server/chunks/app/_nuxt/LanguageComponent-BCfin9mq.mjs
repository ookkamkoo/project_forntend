...
import { createVNode, defineComponent, provide, computed, ref, onUnmounted, shallowRef, watch, toRef, getCurrentInstance, Transition, withDirectives, vShow, Fragment, inject, watchEffect, unref, Teleport, useSSRContext, toRaw, mergeProps, withCtx, openBlock, createBlock, createCommentVNode } from 'vue';
import { A as AntdIcon, P as PropTypes, R as ResizeObserver, c as classNames, K as Keyframes, aa as Trigger, ab as buttonProps, B as Button, i as initDefaultProps, u as useConfigInject, p as warning$1, a1 as devWarning, l as cloneElement, ac as getPlacements, o as omit, k as flattenChildren, T as Tooltip, G as wrapperRaf, b as getTransitionProps, ad as isValid, V as getPropsSlot, a as collapseMotion, ae as skipFlattenKey, s as someType, v as objectType, x as booleanType, D as eventType, r as genComponentStyleHook, H as isValidElement, t as tuple, J as merge, M as genCollapseMotion$1, a4 as initZoomMotion, af as initMotion, Q as resetComponent, ag as roundedArrow, ah as genFocusStyle, ai as getArrowOffset, aj as textEllipsis, S as clearFix, U as genFocusOutline, ak as resetIcon } from './collapseMotion-HiYDSwVT.mjs';
import _objectSpread$4 from '@babel/runtime/helpers/esm/objectSpread2';
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(ResizeObserver, {
        ...
        default: () => createVNode(Component, _objectSpread$4(_objectSpread$4(_objectSpread$4({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      if (!context.value) {
        ...
        return createVNode(Component, _objectSpread$4(_objectSpread$4({}, restProps2), attrs), {
      ...
      return createVNode(OverflowContextProvider, {
        ...
        default: () => [createVNode(Item, _objectSpread$4(_objectSpread$4(_objectSpread$4({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      const internalRenderItemNode = renderRawItem ? (item, index) => {
        ...
        const key = getKey(item, index);
        return createVNode(Item, _objectSpread$4(_objectSpread$4({}, itemSharedProps), {}, {
          "order": index,
          "key": key,
          "item": item,
      ...
      if (!renderRawRest) {
        ...
        restNode = () => createVNode(Item, _objectSpread$4(_objectSpread$4({}, itemSharedProps), restContextProps), {
      ...
      const overflowNode = () => {
        var _a;
        return createVNode(Component, _objectSpread$4({
          "id": id,
          "class": classNames(!invalidate.value && prefixCls, className),
          "style": style,
          "onMousedown": onMousedown
        }, restAttrs), {
          default: () => [mergedData.value.map(internalRenderItemNode), showRest.value ? restNode() : null, suffix && createVNode(Item, _objectSpread$4(_objectSpread$4({}, itemSharedProps), {}, {
...
const Dropdown$2 = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(Trigger, _objectSpread$4(_objectSpread$4({}, otherProps), {}, {
        "prefixCls": prefixCls,
        "ref": triggerRef,
...
const DropdownButton = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return wrapSSR(createVNode(ButtonGroup, _objectSpread$4(_objectSpread$4({}, restProps), {}, {
...
const __nuxt_component_1 = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(Tooltip, _objectSpread$4(_objectSpread$4({}, tooltipProps), {}, {
        "placement": rtl.value ? "left" : "right",
        "overlayClassName": `${prefixCls.value}-inline-collapsed-tooltip`
      }), {
        default: () => [createVNode(Overflow$1.Item, _objectSpread$4(_objectSpread$4(_objectSpread$4({
          "component": "li"
        }, attrs), {}, {
          "id": props.id,
...
const InternalSubMenuList = (_props, _ref) => {
  ...
  return createVNode("ul", _objectSpread$4(_objectSpread$4({}, attrs), {}, {
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(MenuContextProvider, {
        ...
        default: () => [createVNode(Overflow$1.Item, _objectSpread$4(_objectSpread$4({
          "component": "li"
        }, attrs), {}, {
          "role": "none",
...
const ItemGroup = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      if (isMeasure)
        return (_a = slots.default) === null || _a === void 0 ? void 0 : _a.call(slots);
      return createVNode("li", _objectSpread$4(_objectSpread$4({}, attrs), {}, {
    ...
    if (opt && typeof opt === "object") {
      ...
      if (children || type === "group") {
        if (type === "group") {
          ...
          return createVNode(ItemGroup, _objectSpread$4(_objectSpread$4({
            "key": mergedKey
          }, restProps), {}, {
            "title": label,
            "originItemValue": opt
        ...
        return createVNode(__nuxt_component_2$1, _objectSpread$4(_objectSpread$4({
          "key": mergedKey
        }, restProps), {}, {
          "title": label,
          "originItemValue": opt
      ...
      if (type === "divider") {
        return createVNode(Divider, _objectSpread$4({
          "key": mergedKey
        }, restProps), null);
      }
      menuInfo.isLeaf = true;
      store.set(mergedKey, menuInfo);
      return createVNode(__nuxt_component_1, _objectSpread$4(_objectSpread$4({
        "key": mergedKey
      }, restProps), {}, {
        "originItemValue": opt
      }), {
...
const Menu = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return wrapSSR(createVNode(Overflow$1, _objectSpread$4(_objectSpread$4({}, attrs), {}, {
...
const Sider = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode("aside", _objectSpread$4(_objectSpread$4({}, attrs), {}, {
        "class": siderCls,
        "style": divStyle
      }), [createVNode("div", {
        "class": `${pre}-children`
...
export { KeyCode$1 as K, LayoutHeader as L, Menu as M, __nuxt_component_0 as _, __nuxt_component_2 as a, LayoutContent as b, LayoutFooter as c, LayoutSider as d, __nuxt_component_1 as e, __nuxt_component_2$1 as f, isNumeric as i };
//# sourceMappingURL=LanguageComponent-BCfin9mq.mjs.map
