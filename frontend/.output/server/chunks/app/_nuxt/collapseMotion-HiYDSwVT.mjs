...
import { inject, ref, h, getCurrentInstance, nextTick, reactive, defineComponent, createVNode, Fragment, isVNode, Comment, Text, onUpdated, onUnmounted, watch, computed, provide, shallowRef, Transition, cloneVNode, toRef, withDirectives, withModifiers, vShow, watchEffect, unref, triggerRef, resolveDirective, render } from 'vue';
    ...
    return () => {
      ...
      return wrapSSR(createVNode(LocaleReceiver, {
        ...
        "children": (locale2) => {
          ...
          return createVNode("div", _objectSpread$4({
...
function Mask(props) {
  ...
  return createVNode(Transition, _objectSpread$4({
    "appear": true
  }, motion), {
...
const PopupInner = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(Transition, _objectSpread$4(_objectSpread$4({
        "ref": elementRef
      }, transitionProps), {}, {
...
const Popup = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      const popupNode = inMobile.value ? createVNode(MobilePopupInner, _objectSpread$4(_objectSpread$4({}, cloneProps), {}, {
        "mobile": props.mobile,
        "ref": popupRef
      }), {
        default: slots.default
      }) : createVNode(PopupInner, _objectSpread$4(_objectSpread$4({}, cloneProps), {}, {
        "ref": popupRef
      }), {
        default: slots.default
      });
...
defineComponent({
  ...
  setup(props, _ref3) {
    ...
    return () => {
      ...
      return wrapSSR(createVNode("div", _objectSpread$4(_objectSpread$4({}, attrs), {}, {
...
const Button = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      if (href !== void 0) {
        return wrapSSR(createVNode("a", _objectSpread$4(_objectSpread$4({}, buttonProps2), {}, {
          "href": href,
          "target": target,
          "ref": buttonNodeRef
        }), [iconNode, kids]));
      }
      let buttonNode = createVNode("button", _objectSpread$4(_objectSpread$4({}, buttonProps2), {}, {
        "ref": buttonNodeRef,
        "type": htmlType
      }), [iconNode, kids]);
...
export { Wave as $, AntdIcon as A, Button as B, arrayType as C, eventType as D, useLocaleReceiver as E, localeValues as F, wrapperRaf as G, isValidElement as H, genCompactItemStyle as I, merge as J, Keyframes as K, LoadingOutlined$1 as L, genCollapseMotion$1 as M, NoCompactStyle as N, zoomIn as O, PropTypes as P, resetComponent as Q, ResizeObserver as R, clearFix as S, Tooltip as T, genFocusOutline as U, getPropsSlot as V, tooltipDefaultProps as W, getTransitionName as X, withInstall as Y, isPresetColor as Z, isPresetStatusColor as _, collapseMotion as a, Portal as a0, devWarning as a1, useConfigContextInject as a2, abstractTooltipProps as a3, initZoomMotion as a4, getArrowStyle as a5, PresetColors as a6, capitalize as a7, genPresetColor as a8, useToken as a9, Trigger as aa, buttonProps as ab, getPlacements as ac, isValid as ad, skipFlattenKey as ae, initMotion as af, roundedArrow as ag, genFocusStyle as ah, getArrowOffset as ai, textEllipsis as aj, resetIcon as ak, getTransitionProps as b, classNames as c, useProviderSize as d, useProviderDisabled as e, filterEmpty as f, getTransitionGroupProps as g, useInjectGlobalForm as h, initDefaultProps as i, useInjectDisabled as j, flattenChildren as k, cloneElement as l, useCompactItemContext as m, anyType as n, omit as o, warning$1 as p, createContext as q, genComponentStyleHook as r, someType as s, tuple as t, useConfigInject as u, objectType as v, warning$2 as w, booleanType as x, stringType as y, functionType as z };
//# sourceMappingURL=collapseMotion-HiYDSwVT.mjs.map
