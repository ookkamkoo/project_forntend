...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/dashboard-D60uzkUI.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-CHsWndAU.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  auth: () => import('./_nuxt/auth-67-21dcT.mjs').then((m) => m.default || m),
  default: () => import('./_nuxt/default-gG7_7Ap4.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-BDj6ZOL5.mjs').then((r) => r.default || r));
